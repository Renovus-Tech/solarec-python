...
from app.endpoints.solar.solar_climate import parse_request, climate
...
def test_climate():
    with mock.patch("app.endpoints.solar.solar_climate.Solar") as mock_solar:
        param_json = '{"from": "2021/01/01T00:00:00", "to": "2021/01/02T00:00:00", "client": 1, "location": 1, "groupBy": "hour", "generators": [1, 2]}'
        ...
        assert response.data[0].totalPredictedACProductionMwh == 12
        ...
        assert response.data[0].genData[0].predictedACProductionMwh == 12
        ...
        assert response.data[0].genData[1].predictedACProductionMwh == 42
        ...
        assert response.data[1].genData[0].predictedACProductionMwh == 22
        assert response.data[1].totalPredictedACProductionMwh == 22
        assert response.data[1].avgAmbientTemp == 25
        assert response.data[1].avgModuleTemp == 30
        ...
        assert response.data[1].genData[1].predictedACProductionMwh == 52
        ...
        assert response.data[2].totalPredictedACProductionMwh == 32
        assert response.data[2].avgAmbientTemp == 30
        assert response.data[2].avgModuleTemp == 35
        ...
        assert response.data[2].genData[0].predictedACProductionMwh == 32
        ...
        assert response.data[2].genData[1].predictedACProductionMwh == 62
