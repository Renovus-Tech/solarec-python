...
def test_get_onboarding_data():
    ...
    with patch('app.nlp.onboarding_helper.LLMClient') as mock_llm_client:
        ...
        onboarding_data = onboarding_helper.get_onboarding_data('The address is New York, the capacity is 1000, and the installation date is 2022-01-01')

        assert onboarding_data.address == 'New York'
