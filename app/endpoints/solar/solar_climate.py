...
def climate(param_json, db: Session = Depends(get_db)):
    ...
    solar = Solar(db, request.client, request.location, None, None, request.start_date, request.end_date, request.freq, request.data_freq)
